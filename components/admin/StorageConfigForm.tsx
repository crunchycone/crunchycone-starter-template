...
import { Loader2, CheckCircle, AlertTriangle, Database, TestTube, Save, HelpCircle } from "lucide-react";
import { getStorageSettings, updateStorageSettings, testStorageConnection } from "@/app/actions/storage-settings";
    ...
    switch (settings.provider) {
      case "aws":
        return {
          ...
          steps: [
            { title: "Create AWS Account", content: "Sign up for AWS if you don't have an account." },
            { title: "Create IAM User", content: "Go to AWS IAM console and create a new user for programmatic access." },
            { title: "Attach S3 Policy", content: "Attach the 'AmazonS3FullAccess' policy or create a custom policy with S3 permissions." },
            { title: "Generate Access Keys", content: "Create access keys for the IAM user. Download and securely store the Access Key ID and Secret Access Key." },
            { title: "Create S3 Bucket", content: "Go to S3 console and create a new bucket in your preferred region." },
            { title: "Configure Bucket", content: "Set appropriate permissions and enable/disable public access as needed." },
            { title: "Optional: CloudFront", content: "For CDN, create a CloudFront distribution pointing to your S3 bucket." },
          ],
      ...
      case "digitalocean":
        return {
          ...
          steps: [
            { title: "Create DigitalOcean Account", content: "Sign up for DigitalOcean if you don't have an account." },
            { title: "Create Spaces", content: "Go to Spaces in the DigitalOcean control panel and create a new Space." },
            { title: "Choose Region", content: "Select a region close to your users for better performance." },
            { title: "Generate API Keys", content: "Go to API → Spaces Keys and generate new credentials." },
            { title: "Get Access Keys", content: "Copy the Access Key ID and Secret Access Key." },
            { title: "Note Space Details", content: "Record your Space name and region for configuration." },
            { title: "Optional: CDN", content: "Enable CDN for your Space to get a CDN endpoint URL." },
          ],
      ...
      case "azure":
        return {
          ...
          steps: [
            { title: "Create Azure Account", content: "Sign up for Azure if you don't have an account." },
            { title: "Create Storage Account", content: "In Azure Portal, create a new Storage Account." },
            { title: "Choose Settings", content: "Select performance tier (Standard/Premium) and replication options." },
            { title: "Create Container", content: "In your storage account, create a new Blob container." },
            { title: "Get Access Keys", content: "Go to Access Keys section and copy one of the connection strings or account keys." },
            { title: "Optional: SAS Token", content: "For more granular access, generate a SAS token instead of using account keys." },
            { title: "Optional: CDN", content: "Enable Azure CDN for your storage account to get a CDN URL." },
          ],
      ...
      case "gcp":
        return {
          ...
          steps: [
            { title: "Create GCP Account", content: "Sign up for Google Cloud if you don't have an account." },
            { title: "Create Project", content: "Create a new project in Google Cloud Console or select an existing one." },
            { title: "Enable Cloud Storage API", content: "Go to APIs & Services and enable the Google Cloud Storage API for your project." },
            { title: "Create Service Account", content: "Go to IAM & Admin → Service Accounts and create a new service account." },
            { title: "Generate Key File", content: "Create and download a JSON key file for the service account. Store this securely." },
            { title: "Set Permissions", content: "Grant the service account 'Storage Admin' or custom storage permissions." },
            { title: "Create Storage Bucket", content: "Go to Cloud Storage and create a new bucket in your preferred region." },
            { title: "Configure Access", content: "Set appropriate bucket permissions and access controls as needed." },
            { title: "Optional: CDN", content: "Set up Cloud CDN or use a custom CDN URL for faster content delivery." },
          ],
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-sm">
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Security Note:</strong> Store your credentials securely and never share them publicly. 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, localStoragePath: e.target.value }))}
                  />
                  <p className="text-sm text-muted-foreground">Local directory path for file storage</p>
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, localStorageBaseUrl: e.target.value }))}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, awsAccessKeyId: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, awsSecretAccessKey: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, awsRegion: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, awsBucket: e.target.value }))}
                  />
                </div>
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, awsCloudFrontDomain: e.target.value }))}
                  />
                </div>
              </div>
            </TabsContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, doAccessKeyId: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, doSecretAccessKey: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, doCdnEndpoint: e.target.value }))}
                  />
                </div>
              </div>
            </TabsContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, azureAccountName: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, azureAccountKey: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, azureContainerName: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, azureSasToken: e.target.value }))}
                  />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="azureConnectionString">Connection String (Alternative to Account Key)</Label>
                  <Input
                    id="azureConnectionString"
                    type="password"
                    placeholder="DefaultEndpointsProtocol=https;AccountName=..."
                    value={settings.azureConnectionString || ""}
                    onChange={(e) => setSettings(prev => ({ ...prev, azureConnectionString: e.target.value }))}
                  />
                </div>
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, azureCdnUrl: e.target.value }))}
                  />
                </div>
              </div>
            </TabsContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, gcpProjectId: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, gcpKeyFile: e.target.value }))}
                  />
                  <p className="text-sm text-muted-foreground">Optional if using other GCP authentication methods</p>
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, gcsBucket: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSettings(prev => ({ ...prev, gcpCdnUrl: e.target.value }))}
                  />
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="crunchycone" className="space-y-4">
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  CrunchyCone Storage uses your CLI authentication and project configuration. No additional settings are required.
                </p>
                  ...
                  <div className="space-y-3">
                      ...
                      <AlertDescription>
                        <div className="space-y-2">
                          <p className="font-medium">
                            {crunchyConeStatus.authenticated ? "✅ Authenticated" : "❌ Not Authenticated"}
                          </p>
                          {crunchyConeStatus.authDetails && crunchyConeStatus.authDetails.user && (
                            <p className="text-sm">
                              Logged in as: {crunchyConeStatus.authDetails.user.email || crunchyConeStatus.authDetails.user.name || "Unknown user"}
                            </p>
                          )}
                          {!crunchyConeStatus.authenticated && (
                            <div className="text-sm space-y-1">
                              <p>You need to sign in to CrunchyCone to use this storage provider.</p>
                              <div className="bg-muted p-2 rounded font-mono text-xs">
                                npx crunchycone-cli auth login
                              </div>
                              <p className="text-muted-foreground">Run this command in your terminal to sign in.</p>
                            </div>
                          )}
                        </div>
                      </AlertDescription>
                    ...
                    <Alert variant={crunchyConeStatus.hasProject ? "default" : "destructive"}>
                      ...
                      <AlertDescription>
                        <div className="space-y-2">
                          <p className="font-medium">
                            {crunchyConeStatus.hasProject ? "✅ Project Configured" : "❌ No Project Linked"}
                          </p>
                          {crunchyConeStatus.hasProject && crunchyConeStatus.projectDetails ? (
                            <p className="text-sm">
                              Project ID: <code className="bg-muted px-1 py-0.5 rounded text-xs">{crunchyConeStatus.projectDetails.project_id}</code>
                            </p>
                          ) : (
                            <div className="text-sm space-y-1">
                              <p>You need to link a CrunchyCone project to use this storage provider.</p>
                              <div className="bg-muted p-2 rounded font-mono text-xs">
                                npx crunchycone-cli project link
                              </div>
                              <p className="text-muted-foreground">Run this command from your project folder to link a project.</p>
                            </div>
                          )}
                        </div>
                      </AlertDescription>
                    ...
                    {crunchyConeStatus.authenticated && crunchyConeStatus.hasProject && (
                      <Alert variant="default">
                        <CheckCircle className="h-4 w-4" />
                        <AlertDescription>
                          <p className="font-medium text-green-700">🎉 CrunchyCone Storage is ready to use!</p>
